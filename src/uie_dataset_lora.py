...
class UIEConfig(datasets.BuilderConfig):
    ...
    def __init__(
        ...
        logger.info(f"class UIEConfig(datasets.BuilderConfig) data_dir={data_dir}, instruction_file={instruction_file}, instruction_strategy={instruction_strategy}, task_config_dir={task_config_dir}, num_examples={num_examples}, max_num_instances_per_task={max_num_instances_per_task}, max_num_instances_per_eval_task={max_num_instances_per_eval_task}, over_sampling={over_sampling}")
...
class UIEInstructions(datasets.GeneratorBasedBuilder):
    ...
    def load_SC_dataset(self, dataset_path, labels_path, dataset_name, sampling_strategy, max_num_instances, subset):
        ...
        logger.info(f"load_SC_dataset dataset_path={dataset_path}, labels_path={labels_path}, dataset_name={dataset_name}, sampling_strategy={sampling_strategy}, max_num_instances={max_num_instances}, subset={subset}")
    ...
    def load_TC_dataset(self, dataset_path, labels_path, dataset_name, sampling_strategy, max_num_instances, subset):
        ...
        logger.info(f"load_TC_dataset dataset_path={dataset_path}, labels_path={labels_path}, dataset_name={dataset_name}, sampling_strategy={sampling_strategy}, max_num_instances={max_num_instances}, subset={subset}")

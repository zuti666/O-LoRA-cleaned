...
CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node=2 --master_port=29502 src/run_uie_lora.py \
   ...
   --output_dir logs_and_outputs_showResults/order_1/Nlora_T5large_torch_AdamwHf_E1/1-dbpedia \
...
CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node=2 --master_port=29502 src/run_uie_lora.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path logs_and_outputs_showResults/order_1/Nlora_T5large_torch_AdamwHf_E1/1-dbpedia/adapter \
   --data_dir CL_Benchmark \
   --task_config_dir configs/order1_configs/amazon \
   --instruction_file configs/instruction_config.json \
   --instruction_strategy single \
   --output_dir logs_and_outputs_showResults/order_1/Nlora_T5large_torch_AdamwHf_E1/2-amazon \
   --per_device_train_batch_size 8 \
   --per_device_eval_batch_size 128 \
   --gradient_accumulation_steps 4 \
   --num_train_epochs 1 \
...
CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node=2 --master_port=29503 src/run_uie_lora.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path logs_and_outputs_showResults/order_1/Nlora_T5large_torch_AdamwHf_E1/2-amazon/adapter \
   --data_dir CL_Benchmark \
   --task_config_dir configs/order1_configs/yahoo \
   --instruction_file configs/instruction_config.json \
   --instruction_strategy single \
   --output_dir logs_and_outputs_showResults/order_1/Nlora_T5large_torch_AdamwHf_E1/3-yahoo \
   --per_device_train_batch_size 8 \
   --per_device_eval_batch_size 128 \
   --gradient_accumulation_steps 4 \
   --num_train_epochs 1 \
...
CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node=2 --master_port=29504 src/run_uie_lora.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path logs_and_outputs_showResults/order_1/Nlora_T5large_torch_AdamwHf_E1/3-yahoo/adapter \
   --data_dir CL_Benchmark \
   --task_config_dir configs/order1_configs/agnews \
   --instruction_file configs/instruction_config.json \
   --instruction_strategy single \
   --output_dir logs_and_outputs_showResults/order_1/Nlora_T5large_torch_AdamwHf_E1/4-agnews \
   --per_device_train_batch_size 8 \
   --per_device_eval_batch_size 128 \
   --gradient_accumulation_steps 4 \
   --num_train_epochs 1 \
